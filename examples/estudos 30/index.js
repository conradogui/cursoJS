...
console.log(pessoasVelhas)//[ { nome: 'Luiz', idade: 62 }, { nome: 'Eduarda', idade: 55 } ]
//pessoas que terminam com a letra a
const pessoasComa = pessoas.filter(valor => valor.nome.toLowerCase().endsWith('a'))//endsWith é que termina com tal coisa
